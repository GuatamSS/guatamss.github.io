 ...
 */
{
    ...
    class Item {
		constructor(el, options) {
            ...
            this.DOM.animatable = {};
            this.DOM.animatable.image = this.DOM.el.querySelector('.box__img2');
            this.DOM.animatable.title = this.DOM.el.querySelector('.box__title2');
            this.DOM.animatable.text = this.DOM.el.querySelector('.box__text2');
            this.DOM.animatable.deco = this.DOM.el.querySelector('.box__deco2');
            this.DOM.animatable.shadow = this.DOM.el.querySelector('.box__shadow2');
            this.DOM.animatable.content = this.DOM.el.querySelector('.box__content2');
    ...
    class Overlay {
        constructor() {
            this.DOM = {el: document.querySelector('.overlay2')};
            this.DOM.reveal = this.DOM.el.querySelector('.overlay__reveal2');
            this.DOM.items = this.DOM.el.querySelectorAll('.overlay__item2');
            this.DOM.close = this.DOM.el.querySelector('.overlay__close2');
        }
        show(contentItem) {
            this.contentItem = contentItem;
            this.DOM.el.classList.add('overlay--open2');
            // show revealer
            TweenMax.to(this.DOM.reveal, .5, {
                ...
                onComplete: () => {
                    // hide scroll
                    document.body.classList.add('preview-open2');
                    // show preview
                    ...
                    this.DOM.close.style.zIndex = 3;
                    this.contentItem.style.zIndex = 2;
                }
            });
        }
        revealItem() {
            ...
            let itemElems = [];
            itemElems.push(this.contentItem.querySelector('.box__shadow2'));
            itemElems.push(this.contentItem.querySelector('.box__img2'));
            itemElems.push(this.contentItem.querySelector('.box__title2'));
            itemElems.push(this.contentItem.querySelector('.box__text2'));
            itemElems.push(this.contentItem.querySelector('.box__deco2'));
            itemElems.push(this.contentItem.querySelector('.overlay__content2'));
        ...
        hide() {
            this.DOM.el.classList.remove('overlay--open2');
            ...
            TweenMax.to(this.DOM.reveal, .5, {
                ...
                onComplete: () => {
                    ...
                    // show scroll
                    document.body.classList.remove('preview-open2');
                    // hide preview
                    ...
                    this.contentItem.style.zIndex = 1;
    ...
    class Grid {
        constructor(el) {
            this.DOM = {el: el};
            this.items = [];
            Array.from(this.DOM.el.querySelectorAll('a.grid__item2')).forEach((item) => {
                const itemObj = new Item(item);
                this.items.push(itemObj);
                if ( !item.classList.contains('grid__item--noclick2') ) {
    ...
    let allowTilt = true;
    new Grid(document.querySelector('.grid2'));

    // Preload all the images in the page..
    imagesLoaded(document.querySelectorAll('.box__img2'), () => document.body.classList.remove('loading'));
}
