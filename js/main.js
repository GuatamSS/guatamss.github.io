 ...
 */
{
    class Details {
        constructor() {
            ...
            this.DOM.details.setAttribute('id','details');
        ...
        open(data) {
            ...
            if(document.querySelector('.product__description').classList.contains('m')){
                this.DOM.description.className+="m";
            }
            if(document.querySelector('.product__title').classList.contains('m')){
                this.DOM.title.className+="m";
            }
            ...
            $('#details').css('overflowY','scroll');
            $("#details").css("backgroundColor","#f5f0ef");
            $(".details__bg--down").css("display","none");
            $('body').addClass('ovh');
        }
        close() {
            $(".details__bg--down").css("display","block");
            if ( this.isAnimating ) return false;
            this.isAnimating = true;
            ...
            $("#details").css("backgroundColor","transparent");
